...
export const ColorPicker = ({
    ...
    return(
        <div className="flex flex-wrap gap-2 items-center max-w-[164px] pr-2 mr-2 border-r border-white/10">
...
const ColorButton = ({
    ...
    return (
        <button
            className="w-8 h-8 items-center flex justify-center hover:scale-110 transition-transform focus:outline-none"
